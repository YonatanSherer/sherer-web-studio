          ...
          <div className="max-w-2xl">
            ...
            >
              <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#00b4ff]/10 border border-[#00b4ff]/20 text-[#00b4ff] text-xs font-medium mb-5">
                ...
                {t("servicesTitle")} · EN · HE · TH · AR · ES · FR · DE · RU
              </span>
            ...
            >
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#25D366]/12 text-[#25D366] text-sm font-medium hover:bg-[#25D366]/22 transition-colors border border-[#25D366]/20"
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#06C755]/12 text-[#06C755] text-sm font-medium hover:bg-[#06C755]/22 transition-colors border border-[#06C755]/20"
