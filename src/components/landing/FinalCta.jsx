...
export default function FinalCta() {
  ...
  return (
    <section dir={isRTL ? "rtl" : "ltr"} className="relative py-16 md:py-20 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-[#060a14] via-[#0a1022] to-[#081428]" />
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(0,180,255,0.08),transparent_60%)]" />
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-2xl md:text-3xl font-bold text-white mb-7"
        >
          {t("finalCtaHeadline")}
        </motion.h2>
        ...
        >
          ...
          <Button
            size="lg"
            asChild
            className="bg-[#25D366] hover:bg-[#20bd5a] text-white font-semibold px-5 h-11 rounded-xl text-sm"
          >
            <a
            ...
            >
              <WhatsAppIcon />
              <span className="ms-2">{t("finalCta2")}</span>
            </a>
          </Button>
          <Button
            size="lg"
            asChild
            className="bg-[#06C755] hover:bg-[#05a847] text-white font-semibold px-5 h-11 rounded-xl text-sm"
          >
            <a
            ...
            >
              <LINEIcon />
              <span className="ms-2">{t("finalCta3")}</span>
            </a>
          </Button>
        </motion.div>
      </div>
