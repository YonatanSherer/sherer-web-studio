...
const LinkedInIcon = () => (
  <svg viewBox="0 0 24 24" width={14} height={14} className="fill-current" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-2.5" style={{ flexDirection: isRTL ? "row-reverse" : "row" }}>
              <a href={CONTACT_LINKS.whatsapp} target="_blank" rel="noopener noreferrer" aria-label={t("floatWhatsApp")}
              ...
              <a href={CONTACT_LINKS.line} target="_blank" rel="noopener noreferrer" aria-label={t("floatLINE")}
              ...
              <a href={CONTACT_LINKS.linkedin} target="_blank" rel="noopener noreferrer" aria-label={t("floatLinkedIn")}
                 className="w-8 h-8 rounded-lg bg-[#0A66C2]/15 text-[#0A66C2] flex items-center justify-center hover:bg-[#0A66C2]/25 transition-colors">
                <LinkedInIcon />
              </a>
              <a href={CONTACT_LINKS.github} target="_blank" rel="noopener noreferrer" aria-label={t("floatGitHub")}
                 className="w-8 h-8 rounded-lg bg-white/6 text-white/70 flex items-center justify-center hover:bg-white/12 hover:text-white transition-colors">
                <GitHubIconSVG />
              </a>
              <a href={CONTACT_LINKS.email} aria-label={t("floatEmail")}
                 className="w-8 h-8 rounded-lg bg-[#EA4335]/15 text-[#EA4335] flex items-center justify-center hover:bg-[#EA4335]/25 transition-colors">
